...
class RequestModel extends Model {
  ...
  RequestModel.fromJson([Map<String, dynamic>? json]) {
    ...
    images = listFromJson<RequestMedia>(json, "images", callback: (e) => RequestMedia.fromJson(e));
    ...
    statusTimeline = json?["status_timeline"] is Map<String, dynamic>
        ? RequestStatusTimeline.fromJson(json?["status_timeline"] as Map<String, dynamic>)
        : null;
...
class RequestLocation {
  ...
  RequestLocation({required this.lat, required this.lng, required this.location});
  ...
  Map<String, dynamic> toJson() => {"lat": lat, "lng": lng, "location": location};
}
...
class RequestStatusTimeline {
  ...
  factory RequestStatusTimeline.fromJson(Map<String, dynamic> json) => RequestStatusTimeline(
